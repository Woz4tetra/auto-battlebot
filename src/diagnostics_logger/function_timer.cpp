...
FunctionTimer::FunctionTimer(std::shared_ptr<DiagnosticsModuleLogger> logger,
                             const std::string &function_name, double warn_threshold_ms)
    : logger_(logger),
...
double FunctionTimer::elapsed_s() const { return elapsed_ms() / 1000.0; }
