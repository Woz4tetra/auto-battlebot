...
TEST_F(DiagnosticsUtilsTest, FlattenMixedTypes) {
    DiagnosticsData data = {{"temperature", 25},
                            {"voltage", 12.5},
...
TEST_F(DiagnosticsUtilsTest, DictToDiagnosticsSimple) {
    DiagnosticsData data = {{"temperature", 25}, {"voltage", 12.5}};

    auto status = dict_to_diagnostics(data, diagnostic_msgs::DiagnosticStatus::OK, "test_module",
                                      "Test message", "test_hardware");
...
TEST_F(DiagnosticsUtilsTest, FlattenWithParentKey) {
    DiagnosticsData data = {{"temp", 25}, {"voltage", 12.5}};
