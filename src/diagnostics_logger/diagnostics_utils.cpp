...
void flatten_recursive(const DiagnosticsData &data, std::map<std::string, std::string> &result,
...
std::map<std::string, std::string> flatten_diagnostics_data(const DiagnosticsData &data,
...
diagnostic_msgs::DiagnosticStatus dict_to_diagnostics(const DiagnosticsData &data, int8_t level,
