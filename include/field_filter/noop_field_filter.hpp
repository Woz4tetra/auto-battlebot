...
class NoopFieldFilter : public FieldFilterInterface {
   public:
    ...
    FieldDescription track_field([[maybe_unused]] TransformStamped tf_visodom_from_camera,
                                 [[maybe_unused]] std::shared_ptr<FieldDescriptionWithInlierPoints>
                                     initial_description) override {
