...
std::shared_ptr<RosPublisher> make_ros_publisher(miniros::NodeHandle &nh,
    ...
    return std::make_shared<RosPublisher>(
        ...
        TypedPublisher<sensor_msgs::CameraInfo>::advertise(nh, "/field_mask/camera_info", 10, true),
        ...
        TypedPublisher<visualization_msgs::MarkerArray>::advertise(nh, "/hazard_markers", 10, true),
